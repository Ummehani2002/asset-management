...
@section('account-link')
    <span class="auth-account-link">Already have an account? <a href="{{ route('login') }}">Log In</a></span>
@endsection

@section('content')

<h2 class="auth-welcome">Create Account</h2>
<p class="auth-subtitle">Sign up to start using Tanseeq Asset Management</p>
