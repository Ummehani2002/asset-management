            ...
            <div class="row">
                ...
                <div class="col-md-2 mb-3">
                    ...
                    <select name="service_type" class="form-control">
                        ...
                        <option value="datacard" {{ request('service_type') == 'datacard' ? 'selected' : '' }}>Data Card</option>
                            ...
                            @foreach($internetServices as $index => $service)
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        @endif
                                        <a href="{{ route('internet-services.download-form', $service->id) }}" 
                                           class="btn btn-sm btn-outline-primary" title="Download Form (PDF)" target="_blank">
