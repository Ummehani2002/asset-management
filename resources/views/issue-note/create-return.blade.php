...
<div class="container">
    ...
    <form action="{{ route('issue-note.store-return') }}" method="POST" autocomplete="off">
        @csrf
        ...
        <div class="row mt-3">
            <div class="col-md-6">
                <label>Returned By (Employee Name)</label>
                <input type="text" name="returned_by_employee_name" class="form-control" placeholder="Who returned the asset">
            </div>
        </div>
...
<button type="submit" class="btn btn-primary mt-3">Save Return Note</button>
